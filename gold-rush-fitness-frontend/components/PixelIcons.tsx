...
export function SettingsIcon({ size = 18, focused: _focused }: { size?: number; focused?: boolean }) {
  const mid  = '#A0522D';
  const light = '#CD853F';
  const gold = '#D4A017';
  const bright = '#f0c040';
  ...
  const pixels: PixelList = [
    ...
    [1,1,light],[0,1,light],
    // body
    [1,1,mid],[2,1,mid],[3,1,mid],[4,1,mid],[5,1,mid],[6,1,mid],
    [1,2,mid],[2,2,mid],[3,2,mid],[4,2,mid],[5,2,mid],[6,2,mid],
    [1,3,mid],[2,3,mid],[3,3,mid],[4,3,mid],[5,3,mid],[6,3,mid],
    [1,4,mid],[2,4,mid],[3,4,mid],[4,4,mid],[5,4,mid],[6,4,mid],
    [1,5,mid],[2,5,mid],[3,5,mid],[4,5,mid],[5,5,mid],[6,5,mid],
    // highlight
    [1,1,light],[2,1,light],
    // hole
    [2,2,hole],[3,2,hole],[4,2,hole],
    [2,3,inner],[3,3,inner],[4,3,inner],
    [2,4,hole],[3,4,hole],[4,4,hole],
    // center
    [3,3,gold],[3,3,bright],
  ];
  return (
